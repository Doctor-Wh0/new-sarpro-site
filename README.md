...
Современный, быстрый и SEO-дружественный B2B сайт для продажи пломб и пломбировочных средств.
...
2. Убедитесь, что у вас есть доступ по SFTP или FTP
...
Форма обратной связи работает через `mailto:` (статический сайт без серверной части). Клиентская валидация и honeypot-поля в `src/components/forms/ContactForm.astro` защищают от спама.
